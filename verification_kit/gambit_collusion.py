...
class CollusionCheckResult:
    ...
    best_colluding_profile: tuple[float, float]
...
def check_pure_nash_collusion(
    strategies_a: list[float],
    strategies_b: list[float],
    payoff_fn: Callable[[float, float], tuple[float, float]],
    honest_strategy_a: float,
    honest_strategy_b: float,
